...
const Signup = () => {
  ...
  return (
    <div className="py-12 xl:py-24 flex items-center justify-center">
      <div className="max-w-2xl mx-4 w-full shadow-2xl overflow-hidden">
        <div className="p-8 md:p-12 lg:p-16 bg-white">
          <div className="h-full flex flex-col justify-center">
            <div className="text-center mb-8">
              <h2 className="text-2xl lg:text-3xl font-normal mb-2">Create Your Account</h2>
              <p className="text-gray-500">Join our pet loving community</p>
            </div>
            ...
            {otpField ? (
              <form onSubmit={handleOtpSubmit} className="space-y-5">
                ...
                >
                  {otp.map((d, i) => (
                    <input
                      ...
                      className="w-12 h-12 text-center border border-gray-300 rounded-md text-xl outline-none focus:ring-2 focus:ring-[#f58f80]"
                    />
                  ))}
                </div>
                <button
                ...
                <button
                  ...
                  className="text-gray-800 mt-2 w-full text-center hover:underline"
                >
                  Resend OTP
                </button>
              </form>
            ...
            <div className="text-center mt-6">
              <p className="text-gray-600">
                ...
                <Link href="/user/login" className="text-[#f58f80] font-semibold hover:underline">
                  Sign In
                </Link>
              </p>
            </div>
